...
local CielbermFolder = "Cielberm"
local ConfigurationFolder = CielbermFolder.."/Configurations"
local ConfigurationExtension = ".cblm"
local settingsTable = {
	General = {
		-- if needs be in order just make getSetting(name)
		cielbermOpen = {Type = 'bind', Value = 'K', Name = 'Cielberm Keybind'},
		-- buildwarnings
		-- rayfieldprompts
...
local overriddenSettings: { [string]: any } = {} -- For example, overriddenSettings["System.cielbermOpen"] = "J"
...
local function loadSettings()
	...
	local success, result =	pcall(function()
		task.spawn(function()
			if isfolder and isfolder(CielbermFolder) then
				if isfile and isfile(CielbermFolder..'/settings'..ConfigurationExtension) then
					file = readfile(CielbermFolder..'/settings'..ConfigurationExtension)
				end
			end
			...
			if useStudio then
				file = [[
		{"General":{"cielbermOpen":{"Value":"K","Type":"bind","Name":"Cielberm Keybind","Element":{"HoldToInteract":false,"Ext":true,"Name":"Cielberm Keybind","Set":null,"CallOnChange":true,"Callback":null,"CurrentKeybind":"K"}}},"System":{"usageAnalytics":{"Value":false,"Type":"toggle","Name":"Anonymised Analytics","Element":{"Ext":true,"Name":"Anonymised Analytics","Set":null,"CurrentValue":false,"Callback":null}}}}
	]]
			end
	...
	if not success then 
		if writefile then
			warn('Cielberm had an issue accessing configuration saving capability.')
		end
	end
end
...
local CielbermLibrary = {
	...
	Theme = {
		Default = {
			...
			ElementStroke = Color3.fromRGB(55, 55, 64),
			SecondaryElementStroke = Color3.fromRGB(45, 45, 52),

			SliderBackground = Color3.fromRGB(55, 55, 64),
			SliderProgress = Color3.fromRGB(99, 102, 241),
			SliderStroke = Color3.fromRGB(129, 140, 248),

			ToggleBackground = Color3.fromRGB(55, 55, 64),
			ToggleEnabled = Color3.fromRGB(34, 197, 94),
			ToggleDisabled = Color3.fromRGB(107, 114, 128),
			ToggleEnabledStroke = Color3.fromRGB(74, 222, 128),
			ToggleDisabledStroke = Color3.fromRGB(156, 163, 175),
			ToggleEnabledOuterStroke = Color3.fromRGB(55, 55, 64),
			ToggleDisabledOuterStroke = Color3.fromRGB(75, 85, 99),

			DropdownSelected = Color3.fromRGB(99, 102, 241),
			DropdownUnselected = Color3.fromRGB(45, 45, 52),

			InputBackground = Color3.fromRGB(32, 32, 38),
			InputStroke = Color3.fromRGB(75, 85, 99),
		...
		Ocean = {
			...
			Topbar = Color3.fromRGB(30, 41, 59),
			Shadow = Color3.fromRGB(0, 0, 0),

			NotificationBackground = Color3.fromRGB(30, 41, 59),
			NotificationActionsBackground = Color3.fromRGB(240, 249, 255),

			TabBackground = Color3.fromRGB(51, 65, 85),
			TabStroke = Color3.fromRGB(71, 85, 105),
			TabBackgroundSelected = Color3.fromRGB(14, 165, 233),
			TabTextColor = Color3.fromRGB(148, 163, 184),
			SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

			ElementBackground = Color3.fromRGB(51, 65, 85),
			ElementBackgroundHover = Color3.fromRGB(71, 85, 105),
			SecondaryElementBackground = Color3.fromRGB(30, 41, 59),
			ElementStroke = Color3.fromRGB(100, 116, 139),
			SecondaryElementStroke = Color3.fromRGB(71, 85, 105),

			SliderBackground = Color3.fromRGB(71, 85, 105),
			SliderProgress = Color3.fromRGB(14, 165, 233),
			SliderStroke = Color3.fromRGB(56, 189, 248),

			ToggleBackground = Color3.fromRGB(71, 85, 105),
			ToggleEnabled = Color3.fromRGB(6, 182, 212),
			ToggleDisabled = Color3.fromRGB(100, 116, 139),
			ToggleEnabledStroke = Color3.fromRGB(34, 211, 238),
			ToggleDisabledStroke = Color3.fromRGB(148, 163, 184),
			ToggleEnabledOuterStroke = Color3.fromRGB(71, 85, 105),
			ToggleDisabledOuterStroke = Color3.fromRGB(100, 116, 139),

			DropdownSelected = Color3.fromRGB(14, 165, 233),
			DropdownUnselected = Color3.fromRGB(71, 85, 105),

			InputBackground = Color3.fromRGB(51, 65, 85),
			InputStroke = Color3.fromRGB(100, 116, 139),
			PlaceholderColor = Color3.fromRGB(148, 163, 184)
		},
		...
		Light = {
			...
			NotificationActionsBackground = Color3.fromRGB(243, 244, 246),

			TabBackground = Color3.fromRGB(229, 231, 235),
			TabStroke = Color3.fromRGB(209, 213, 219),
			TabBackgroundSelected = Color3.fromRGB(99, 102, 241),
			TabTextColor = Color3.fromRGB(107, 114, 128),
			SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

			ElementBackground = Color3.fromRGB(255, 255, 255),
			ElementBackgroundHover = Color3.fromRGB(243, 244, 246),
			SecondaryElementBackground = Color3.fromRGB(249, 250, 251),
			ElementStroke = Color3.fromRGB(229, 231, 235),
			SecondaryElementStroke = Color3.fromRGB(209, 213, 219),

			SliderBackground = Color3.fromRGB(229, 231, 235),
			SliderProgress = Color3.fromRGB(99, 102, 241),
			SliderStroke = Color3.fromRGB(129, 140, 248),

			ToggleBackground = Color3.fromRGB(229, 231, 235),
			ToggleEnabled = Color3.fromRGB(34, 197, 94),
			ToggleDisabled = Color3.fromRGB(156, 163, 175),
			ToggleEnabledStroke = Color3.fromRGB(74, 222, 128),
			ToggleDisabledStroke = Color3.fromRGB(209, 213, 219),
			ToggleEnabledOuterStroke = Color3.fromRGB(229, 231, 235),
			ToggleDisabledOuterStroke = Color3.fromRGB(243, 244, 246),

			DropdownSelected = Color3.fromRGB(99, 102, 241),
			DropdownUnselected = Color3.fromRGB(243, 244, 246),

			InputBackground = Color3.fromRGB(255, 255, 255),
			InputStroke = Color3.fromRGB(209, 213, 219),
			PlaceholderColor = Color3.fromRGB(107, 114, 128)
		},
...
local Cielberm = useStudio and script.Parent:FindFirstChild('Cielberm') or game:GetObjects("rbxassetid://10804731440")[1]
local buildAttempts = 0
local correctBuild = false
local warned
local globalLoaded
local rayfieldDestroyed = false -- True when CielbermLibrary:Destroy() is called

repeat
	if Cielberm:FindFirstChild('Build') and Cielberm.Build.Value == InterfaceBuild then
		correctBuild = true
		break
	end
	...
	if not warned then
		warn('Cielberm | Build Mismatch')
		print('Cielberm may encounter issues as you are running an incompatible interface version ('.. ((Cielberm:FindFirstChild('Build') and Cielberm.Build.Value) or 'No Build') ..').\n\nThis version of Cielberm is intended for interface build '..InterfaceBuild..'.')
		warned = true
	end

	toDestroy, Cielberm = Cielberm, useStudio and script.Parent:FindFirstChild('Cielberm') or game:GetObjects("rbxassetid://10804731440")[1]
	if toDestroy and not useStudio then toDestroy:Destroy() end

	buildAttempts = buildAttempts + 1
until buildAttempts >= 2

Cielberm.Enabled = false

if gethui then
	Cielberm.Parent = gethui()
elseif syn and syn.protect_gui then 
	syn.protect_gui(Cielberm)
	Cielberm.Parent = CoreGui
elseif not useStudio and CoreGui:FindFirstChild("RobloxGui") then
	Cielberm.Parent = CoreGui:FindFirstChild("RobloxGui")
...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == Cielberm.Name and Interface ~= Cielberm then
			Interface.Enabled = false
			Interface.Name = "Cielberm-Old"
		end
	end
elseif not useStudio then
...
if Cielberm.AbsoluteSize.X < minSize.X and Cielberm.AbsoluteSize.Y < minSize.Y then
...
local Main = Cielberm.Main
local MPrompt = Cielberm:FindFirstChild('Prompt')
local Topbar = Main.Topbar
local Elements = Main.Elements
local LoadingFrame = Main.LoadingFrame
local TabList = Main.TabList
local dragBar = Cielberm:FindFirstChild('Drag')
...
local Notifications = Cielberm.Notifications

local SelectedTheme = CielbermLibrary.Theme.Default

local function ChangeTheme(Theme)
	if typeof(Theme) == 'string' then
		SelectedTheme = CielbermLibrary.Theme[Theme]
	elseif typeof(Theme) == 'table' then
		SelectedTheme = Theme
	end

	Cielberm.Main.BackgroundColor3 = SelectedTheme.Background
	Cielberm.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
	Cielberm.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar
	Cielberm.Main.Shadow.Image.ImageColor3 = SelectedTheme.Shadow

	Cielberm.Main.Topbar.ChangeSize.ImageColor3 = SelectedTheme.TextColor
	Cielberm.Main.Topbar.Hide.ImageColor3 = SelectedTheme.TextColor
	Cielberm.Main.Topbar.Search.ImageColor3 = SelectedTheme.TextColor
	if Topbar:FindFirstChild('Settings') then
		Cielberm.Main.Topbar.Settings.ImageColor3 = SelectedTheme.TextColor
		Cielberm.Main.Topbar.Divider.BackgroundColor3 = SelectedTheme.ElementStroke
	end
	...
	for _, text in ipairs(Cielberm:GetDescendants()) do
...
local function getAssetUri(id: any): string
	...
	elseif type(id) == "string" and not Icons then
		warn("Cielberm | Cannot use Lucide icons as icons library is not loaded")
	else
		warn("Cielberm | The icon argument must either be an icon ID (number) or a Lucide icon name (string)")
	end
	return assetUri
end
...
local function LoadConfiguration(Configuration)
	...
	if not success then warn('Cielberm had an issue decoding the configuration file, please try delete the file and reopen Cielberm.') return end

	-- Iterate through current UI elements' flags
	for FlagName, Flag in pairs(CielbermLibrary.Flags) do
		...
		if (typeof(FlagValue) == 'boolean' and FlagValue == false) or FlagValue then
			...
			warn("Cielberm | Unable to find '"..FlagName.. "' in the save file.")
			print("The error above may not be an issue if new elements have been added or not been set values.")
			--CielbermLibrary:Notify({Title = "Cielberm Flags", Content = "Cielberm was unable to find '"..FlagName.. "' in the save file. Check sirius.menu/discord for help.", Image = 3944688398})
		end
	end
...
local function SaveConfiguration()
	...
	local Data = {}
	for i, v in pairs(CielbermLibrary.Flags) do
...
function CielbermLibrary:Notify(data) -- action e.g open messages
	task.spawn(function()
		...
		if data.Actions then
			warn('Cielberm | Not seeing your actions in notifications?')
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			CielbermLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Show'.", Duration = 7, Image = 4400697855})
		else
			CielbermLibrary:Notify({Title = "Interface Hidden", Content = `The interface has been hidden, you can unhide the interface by tapping {getSetting("General", "cielbermOpen")}.`, Duration = 7, Image = 4400697855})
		end
	end
...
local function Maximise()
	...
	TweenService:Create(Topbar.UIStroke, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {ImageTransparency = 0.3}):Play()
...
local function Unhide()
	...
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0.3}):Play()
...
local function saveSettings() -- Save settings to config file
	...
	if success then
		...
		if writefile then
			writefile(CielbermFolder..'/settings'..ConfigurationExtension, encoded)
		end
	end
end
...
local function createSettings(window)
	...
	local newTab = window:CreateTab('Cielberm Settings', 0, true)

	if TabList['Cielberm Settings'] then
		TabList['Cielberm Settings'].LayoutOrder = 1000
	end

	if Elements['Cielberm Settings'] then
		Elements['Cielberm Settings'].LayoutOrder = 1000
	end
...
function CielbermLibrary:CreateWindow(Settings)
	print('creating window')
	if Cielberm:FindFirstChild('Loading') then
		if getgenv and not getgenv().rayfieldCached then
			Cielberm.Enabled = true
			Cielberm.Loading.Visible = true

			task.wait(1.4)
			Cielberm.Loading.Visible = false
		end
	end
	...
	if not correctBuild and not Settings.DisableBuildWarnings then
		task.delay(3, 
			function() 
				CielbermLibrary:Notify({Title = 'Build Mismatch', Content = 'Cielberm may encounter issues as you are running an incompatible interface version ('.. ((Cielberm:FindFirstChild('Build') and Cielberm.Build.Value) or 'No Build') ..').\n\nThis version of Cielberm is intended for interface build '..InterfaceBuild..'.\n\nTry rejoining and then run the script twice.', Image = 4335487866, Duration = 15})		
			end)
	end
	...
	if Settings.ToggleUIKeybind then -- Can either be a string or an Enum.KeyCode
		...
		if type(keybind) == "string" then
			...
			overrideSetting("General", "cielbermOpen", keybind)
		elseif typeof(keybind) == "EnumItem" then
			assert(keybind.EnumType == Enum.KeyCode, "ToggleUIKeybind must be a KeyCode enum")
			overrideSetting("General", "cielbermOpen", keybind.Name)
		else
			error("ToggleUIKeybind must be a string or KeyCode enum")
		end
	end

	if isfolder and not isfolder(CielbermFolder) then
		makefolder(CielbermFolder)
	end
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Cielberm"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Interface Suite"

	if Settings.LoadingTitle ~= "Cielberm Interface Suite" then
		LoadingFrame.Version.Text = "Cielberm UI"
	end

	-- Support both Icon and Logo parameters (Logo takes precedence)
	local iconToUse = Settings.Logo or Settings.Icon
	if iconToUse and iconToUse ~= 0 and Topbar:FindFirstChild('Icon') then
		Topbar.Icon.Visible = true
		Topbar.Title.Position = UDim2.new(0, 47, 0.5, 0)

		if typeof(iconToUse) == 'string' then
			-- Check if it's a Lucide icon name or an asset ID
			if Icons and not string.match(iconToUse, "^%d+$") then
				-- It's a Lucide icon name
				local asset = getIcon(iconToUse)
				...
				-- It's an rbxassetid string
				Topbar.Icon.Image = "rbxassetid://" .. iconToUse
			end
		elseif typeof(iconToUse) == 'number' then
			Topbar.Icon.Image = "rbxassetid://" .. iconToUse
		else
	...
	if not Settings.DisableCielbermPrompts then
		task.spawn(function()
			while true do
				task.wait(math.random(180, 600))
				CielbermLibrary:Notify({
					Title = "Cielberm Interface",
	...
	if Settings.Discord and Settings.Discord.Enabled and not useStudio then
		if isfolder and not isfolder(CielbermFolder.."/Discord Invites") then
			makefolder(CielbermFolder.."/Discord Invites")
		end

		if isfile and not isfile(CielbermFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension) then
			if requestFunc then
				pcall(function()
					requestFunc({
			...
			if Settings.Discord.RememberJoins then -- We do logic this way so if the developer changes this setting, the user still won't be prompted, only new users
				writefile(CielbermFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension,"Cielberm RememberJoins is true for this invite, this invite will not ask you to join again")
			end
		end
	end
	...
	if (Settings.KeySystem) then
		...
		if isfolder and not isfolder(CielbermFolder.."/Key System") then
			makefolder(CielbermFolder.."/Key System")
		end
		...
		if Settings.KeySettings.GrabKeyFromSite then
			for i, Key in ipairs(Settings.KeySettings.Key) do
				...
				if not Success then
					print("Cielberm | "..Key.." Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Cielberm specific development.')
				end
			end
		end
		...
		if isfile and isfile(CielbermFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			for _, MKey in ipairs(Settings.KeySettings.Key) do
				if string.find(readfile(CielbermFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension), MKey) then
					Passthrough = true
				end
			end
		end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(CielbermFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, FoundKey)
						end
						CielbermLibrary:Notify({Title = "Key System", Content = "The key for this script has been saved successfully.", Image = 3605522284})
					end
				else
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				-- Prevents animation from trying to play if the button's callback called CielbermLibrary:Destroy()
				if rayfieldDestroyed then
					return
				end
				if not Success then
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
					TweenService:Create(Button.ElementIndicator, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {TextTransparency = 1}):Play()
					TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
					Button.Title.Text = "Callback Error"
					print("Cielberm | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Cielberm specific development.')
					task.wait(0.5)
					Button.Title.Text = ButtonSettings.Name
					...
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(34, 197, 94)}):Play()
					TweenService:Create(Button.ElementIndicator, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {TextTransparency = 1}):Play()
					TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
					task.wait(0.15)
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			ColorPicker.Interact.MouseButton1Down:Connect(function()
				...
				if not opened then
					...
					TweenService:Create(Main, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {ImageTransparency = SelectedTheme ~= CielbermLibrary.Theme.Default and 0.25 or 0.1}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ColorPickerSettings.Flag then
					CielbermLibrary.Flags[ColorPickerSettings.Flag] = ColorPickerSettings
				end
			end
			...
			Cielberm.Main:GetPropertyChangedSignal('BackgroundColor3'):Connect(function()
				for _, rgbinput in ipairs(ColorPicker.RGB:GetChildren()) do
					if rgbinput:IsA("Frame") then
						rgbinput.BackgroundColor3 = SelectedTheme.InputBackground
						rgbinput.UIStroke.Color = SelectedTheme.InputStroke
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					TweenService:Create(Input, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
					TweenService:Create(Input.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
					Input.Title.Text = "Callback Error"
					print("Cielberm | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Cielberm specific development.')
					task.wait(0.5)
					Input.Title.Text = InputSettings.Name
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and InputSettings.Flag then
					CielbermLibrary.Flags[InputSettings.Flag] = InputSettings
				end
			end
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			local function SetDropdownOptions()
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					DropdownOption.Interact.MouseButton1Click:Connect(function()
						...
						if not Success then
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
							TweenService:Create(Dropdown.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
							Dropdown.Title.Text = "Callback Error"
							print("Cielberm | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
							warn('Check docs.sirius.menu for help with Cielberm specific development.')
							task.wait(0.5)
							Dropdown.Title.Text = DropdownSettings.Name
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and DropdownSettings.Flag then
					CielbermLibrary.Flags[DropdownSettings.Flag] = DropdownSettings
				end
			end
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			UserInputService.InputBegan:Connect(function(input, processed)
				...
				elseif not KeybindSettings.CallOnChange and KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
							TweenService:Create(Keybind.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
							Keybind.Title.Text = "Callback Error"
							print("Cielberm | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							warn('Check docs.sirius.menu for help with Cielberm specific development.')
							task.wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and KeybindSettings.Flag then
					CielbermLibrary.Flags[KeybindSettings.Flag] = KeybindSettings
				end
			end
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			if SelectedTheme ~= CielbermLibrary.Theme.Default then
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
					Toggle.Title.Text = "Callback Error"
					print("Cielberm | "..ToggleSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Cielberm specific development.')
					task.wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if not ToggleSettings.Ext then
				if Settings.ConfigurationSaving then
					if Settings.ConfigurationSaving.Enabled and ToggleSettings.Flag then
						CielbermLibrary.Flags[ToggleSettings.Flag] = ToggleSettings
					end
				end
			end
		...
		function Tab:CreateSlider(SliderSettings)
				...
				local Loop; Loop = RunService.Stepped:Connect(function()
					if SLDragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(239, 68, 68)}):Play()
								TweenService:Create(Slider.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
								Slider.Title.Text = "Callback Error"
								print("Cielberm | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								warn('Check docs.sirius.menu for help with Cielberm specific development.')
								task.wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and SliderSettings.Flag then
					CielbermLibrary.Flags[SliderSettings.Flag] = SliderSettings
				end
			end
	...
	function Window.ModifyTheme(NewTheme)
		...
		if not success then
			CielbermLibrary:Notify({Title = 'Unable to Change Theme', Content = 'We are unable find a theme on file.', Image = 4400704299})
		else
			CielbermLibrary:Notify({Title = 'Theme Changed', Content = 'Successfully changed theme to '..(typeof(NewTheme) == 'string' and NewTheme or 'Custom Theme')..'.', Image = 4483362748})
		end
	end
	...
	if not success then warn('Cielberm had an issue creating settings.') end
...
function CielbermLibrary:SetVisibility(visibility: boolean)
	setVisibility(visibility, false)
end

function CielbermLibrary:IsVisible(): boolean
	return not Hidden
end

local hideHotkeyConnection -- Has to be initialized here since the connection is made later in the script
function CielbermLibrary:Destroy()
...
if Topbar:FindFirstChild('Settings') then
	Topbar.Settings.MouseButton1Click:Connect(function()
		task.spawn(function()
			...
			Elements.UIPageLayout:JumpTo(Elements['Cielberm Settings'])
		end)
	end)
...
hideHotkeyConnection = UserInputService.InputBegan:Connect(function(input, processed)
	if (input.KeyCode == Enum.KeyCode[getSetting("General", "cielbermOpen")]) and not processed then
		if Debounce then return end
		if Hidden then
			Hidden = false
			Unhide()
...
function CielbermLibrary:LoadConfiguration()
	local config
	...
	if CEnabled then
		...
		local success, result = pcall(function()
			...
			if isfile then 
				...
				notified = true
				CielbermLibrary:Notify({Title = "Cielberm Configurations", Content = "We couldn't enable Configuration Saving as you are not using software with filesystem support.", Image = 4384402990})
			end
		end)

		if success and loaded and not notified then
			CielbermLibrary:Notify({Title = "Cielberm Configurations", Content = "The configuration file for this script has been loaded from a previous session.", Image = 4384403532})
		elseif not success and not notified then
			warn('Cielberm Configurations Error | '..tostring(result))
			CielbermLibrary:Notify({Title = "Cielberm Configurations", Content = "We've encountered an issue loading your configuration correctly.\n\nCheck the Developer Console for more information.", Image = 4384402990})
		end
	end
...
if useStudio then
	...
	--local Window = CielbermLibrary:CreateWindow({
	--	Name = "Cielberm Example Window",
	--	LoadingTitle = "Cielberm Interface Suite",
	--	Theme = 'Default',
	--	Icon = 0,
	...
	--		FileName = "Key", -- It is recommended to use something unique as other scripts using Cielberm may overwrite your key file
	--		SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
	--		GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Cielberm to get the key from
	...
	----CielbermLibrary:Notify({Title = "Cielberm Interface", Content = "Welcome to Cielberm. These - are the brand new notification design for Cielberm, with custom sizing and Cielberm calculated wait times.", Image = 4483362458})
	...
	--local thoptions = {}
	--for themename, theme in pairs(CielbermLibrary.Theme) do
